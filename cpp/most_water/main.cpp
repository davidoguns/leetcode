...
public:
    int maxArea(vector<int>& height) {
        ...
        size_t back_index = height.size()-1;
        ...
        while (front_index < back_index) {
            ...
            int area = (back_index - front_index) * std::min(front_height, back_height);
            max_area = std::max(max_area, area);

            if (front_height < back_height) {
                front_index = fn_scan_up_until(front_index, height, back_index, front_height);
            } else {
                back_index = fn_scan_down_until(back_index, height, front_index, back_height);
            }
        }
